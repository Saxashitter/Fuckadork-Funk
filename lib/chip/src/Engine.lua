...
---
--- The type of device this game is being played on.
---
Engine.deviceType = "PC"

local os = love.system.getOS()

if os == "Android" or os == "iOS" then
	Engine.deviceType = "Mobile"
end

-- todo: determine console checks

---
--- The reference width, in case of no borders.
---
Engine.referenceWidth = Engine.gameWidth

---
--- The reference width, in case of no borders.
---
Engine.referenceHeight = Engine.gameHeight

---
--- Are we using "No Borders" mode?
---
Engine.noBorders = false
...
---
--- The physics rate of the game.
---
Engine.physicsPerFrame = 4
...
---
--- A signal that is fired before the game's physics run.
---
Engine.prePhysics = Signal:new() --- @type chip.utils.Signal

---
--- A signal that is fired after the game's physics run.
---
Engine.postPhysics = Signal:new() --- @type chip.utils.Signal
...
---
Engine.lowPowerMode = false --- @type boolean
