...
function Camera:constructor()
	...
	--- @protected
	---
	self._referenceType = 0 --- @type number
	...
	--- @protected
	---
	self._drawData = {} --- @type table

	---
	--- @protected
	---
	self._members = {} --- @type table
end
...
function Camera:getZoom()
	local scale = self._zoom

    return scale
end

function Camera:getRawZoom()
	return self._zoom
end
...
function Camera:getReferenceType()
	return self._referenceType
end

function Camera:setReferenceType(val)
	self._referenceType = val
end
...
function Camera:push()
	...
	self._drawData = {love.graphics.getScissor()}

	love.graphics.push()
	love.graphics.translate(Engine.gameWidth/2, Engine.gameHeight/2)
